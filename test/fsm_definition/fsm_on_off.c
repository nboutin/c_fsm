...
static void on_entry_action(const struct fsm_event_s* event);
static void on_exit_action(const struct fsm_event_s* event);
static void off_entry_action(const struct fsm_event_s* event);
static void off_exit_action(const struct fsm_event_s* event);
